...
#     0: [(entity_entity_factories.health_potion, 35)],
#     2: [(entity_entity_factories.confusion_scroll, 10)],
#     4: [(entity_entity_factories.lightning_scroll, 25), (entity_entity_factories.sword, 5)],
#     6: [(entity_entity_factories.fireball_scroll, 25), (entity_entity_factories.chain_mail, 15)],
# }
